...
client = pymongo.MongoClient("mongodb+srv://sable48642_db_user:IW6WaMZx9jaERG8U@insurance.p2yxuuv.mongodb.net/?retryWrites=true&w=majority&appName=Insurance")
db = client["insurance"]
